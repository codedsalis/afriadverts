<template>
  <nav
    class="md:hidden flex fixed w-full items-center justify-between px-6 h-16 bg-white text-gray-700 border-b border-gray-200 z-10"
  >
    ...
    >
      <span @click="isOpen = false" class="flex w-full items-center p-4 border-b">
        <img src="/img/afrilogo.small.png" alt="Logo" class="h-auto w-32 mx-auto" />
      </span>
      <span @click="isOpen = false" class="flex items-center p-4 hover:bg-aa-dark hover:text-white">
        <span class="mr-2">
          <svg
            fill="none"
            stroke="currentColor"
      ...
      <div class="fixed bottom-0 w-full">
        ...
        <a
          ...
          target="_blank"
        >
          <img class="mr-2 h-8 w-auto" src="/sidebar/bmc.svg" alt="Buy Me Coffee" />
          <p>

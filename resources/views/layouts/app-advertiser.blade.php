    ...
    <div id="app">
        ...
        <div class="flex h-screen">
            <div class="bg-gray-200 w-0 md:w-1/5 invisible md:visible overflow-auto text-black p-0">
                ...
                <a href="/a/adverts">
                    <button
                        class="antialiased p-4 text-aa-dark text-left text-lg hover:bg-gray-400 hover:text-aa-darker rounded-r-full rounded-l-lg w-full">
                        <i class="fa fa-bullhorn"></i> Adverts
                    </button>
                </a>
                <a href="/a/adverts">
                    <button
                        class="antialiased p-4 text-aa-dark text-left text-lg hover:bg-gray-400 hover:text-aa-darker rounded-r-full rounded-l-lg w-full">
                        <i class="fa fa-bullseye"></i> New campaign
                    </button>
                </a>
